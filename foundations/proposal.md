...
| `candidate/sample/` | Non-empty sample of inputs `collect()` produces well-formed output for. The schema-validator-sample triplet from [zero-four.md](zero-four.md) §0.0→0.1 — without this, the candidate is a 0.0 free-write of a collector. |

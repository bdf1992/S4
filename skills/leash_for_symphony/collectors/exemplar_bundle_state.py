...
Per-surface twin of skills/leash_for_hooks/collectors/exemplar_bundle_state.py
and skills/leash_for_slash_commands/collectors/exemplar_bundle_state.py —
same shape, PROMOTED_DIR resolved relative to *this* skill so each leash
counts its own corpus toward MIN_EXEMPLARS."""
...
INPUTS = ["skills/leash_for_symphony/exemplars/promoted/*.json"]

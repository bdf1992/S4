...
context_state-namespaced copy. Mirrors skills/leash_for_hooks/lib/data_point.py
in shape; kept local so the skill is self-contained and does not import from
any sibling. Same un-grounding disclosure (Event 001) as the original applies;
debts D-001 / D-002 track the gap.

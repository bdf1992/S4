...
Vendored from skills/claim_audit/lib/data_point.py at gap_audit creation
time, per the each-skill-carries-its-own-lib convention. See:
foundations/data-point.md (the bedrock this implements).
"""
